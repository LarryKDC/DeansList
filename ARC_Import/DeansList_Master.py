...
os.chdir(r'C:\Users\larry.jerome\Box Sync\Larry\Deanslist')

#access api keys from config file stored locally -- DO NOT STORE API KEYS IN PUBLICLY ACCESSIBLE LOCATION
apiKeys = Config.read(r'C:\Users\larry.jerome\Box Sync\Larry\Deanslist\Scripts\api_keys.config') # use this command to access a school's api key: apiKey_aim = config.get('school','aim')
